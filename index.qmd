...
```{r}
#| label: Barbara - Tabela pelo pacote {modelsummary}
#| eval: FALSE

step1 <- lm(formula = igi_escore ~ sexo + idade + superior_completo + etnia_tr + estado_civil_tr  + ocupacao_tr , data=barbara_variaveis_NA)

step2 <- lm(formula = igi_escore ~ sexo + idade + superior_completo + etnia_tr + estado_civil_tr  + ocupacao_tr + neuroticismo_escore_t + extroversao_escore_t + abertura_escore_t + amabilidade_escore_t + conscienciosidade_escore_t, data=barbara_variaveis_NA)

step3 <- lm(formula = igi_escore ~ sexo + idade + superior_completo + etnia_tr + estado_civil_tr + ocupacao_tr + neuroticismo_escore_t + extroversao_escore_t + abertura_escore_t + amabilidade_escore_t + conscienciosidade_escore_t + ehad_ansiedade_escore + ehad_depressao_escore, data=barbara_variaveis_NA)
...
model_parameters(step3, ci = 0.95, standardize = "refit")
```
